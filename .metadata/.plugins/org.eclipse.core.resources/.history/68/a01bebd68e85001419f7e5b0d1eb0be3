...
public class PokeInput {
	...
	public static ArrayList<Pokemon> Brock(){
		...
		for(int i = 0; i < PokeMain.Pkmn.size(); i++){
			System.out.println(PokeMain.Pkmn.get(i).getType1());
			if(PokeMain.Pkmn.get(i).getType1().equals("Grass")||PokeMain.Pkmn.get(i).getType1().equals("Water")||PokeMain.Pkmn.get(i).getType1().equals("Fighting")){
